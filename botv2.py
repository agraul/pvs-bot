...
def on_message(message):
    ...
    if content.startswith('+!'):
        if channel == discord.utils.get(message.server.channels,
                                        name='role-assignment') or channel == discord.utils.get(message.server.channels,
                                        name='private-bot-testing'):
        ...
        or channel == discord.utils.get(message.server.channels, name='private-bot-testing')):
